...
class CrateTile extends Chest
{
    ...
    public function previewCrate(Player $player): void
    {
        ...
        foreach ($drops as $crateItem) {
            ...
            $item->setLore([TextFormat::RESET, TextFormat::RESET . PiggyCrates::getInstance()->getMessage("crates.preview.item.lore", ["{CHANCE}" => round(($crateItem->chance / $chances) * 100, 2)])]);
